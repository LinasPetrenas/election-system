...
var SingleMemberMainResultElementComponent = React.createClass({
    ...
    if ( progress == 100 ) {
        ...
        return <tr>
        <td><Link to={'/singleMember/county-result/' + this.props.county.countyId}>{this.props.county.countyName}</Link></td>
...
window.SingleMemberMainResultElementComponent = SingleMemberMainResultElementComponent;
